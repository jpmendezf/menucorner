...
def edit(request, pk):
    ...
    if request.method == "POST":
        ...
        questions = survey.question_set.all()
        return render(request, "menu/edit.html", {"survey": survey, "questions": questions})
...
def question_create(request, pk):
    ...
    return render(request, "menu/question.html", {"survey": survey, "form": form})
...
def start(request, pk):
    ...
    return render(request, "menu/start.html", {"survey": survey})
